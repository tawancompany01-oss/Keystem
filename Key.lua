...
local Config = {
    ...
    ServiceId       = 25877, -- Your PlatoBoost Service ID
    PlatoSecret     = "18fb0bfc-8344-4959-8655-e756a715f38d", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "589452", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/tawancompany01-oss/Keystem/refs/heads/main/JubMrua.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "t", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "t", -- Name of the main script's GUI to check if it's already executing
